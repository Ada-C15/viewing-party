...
# TEST 1 - WAVE 1 - PASSED
def test_create_movie_all_params_valid_returns_movie(): # passed
    # Arrange
    movie_title = "Title A"
    genre = "Horror"
    rating = 3.5
...
def test_add_to_watched_adds_movie_to_user_watched():
    ...
    user_data = {
        "watched": []
    } # "watched" = [{movie_1_dict, movie_2_dict...}]
    # Act
